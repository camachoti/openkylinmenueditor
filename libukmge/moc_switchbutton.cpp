...
QT_MOC_LITERAL(4, 37, 13), // "disabledClick"
QT_MOC_LITERAL(5, 51, 11) // "updatevalue"

    },
    "SwitchButton\0checkedChanged\0\0checked\0"
    "disabledClick\0updatevalue"
};
...
void SwitchButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SwitchButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SwitchButton::disabledClick)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void SwitchButton::disabledClick()
{
