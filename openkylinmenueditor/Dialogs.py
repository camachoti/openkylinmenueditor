...
import openkylinmenueditor_lib
...
class AboutDialog(Gtk.AboutDialog):
    def __init__(self, parent, use_headerbar):
        ...
        self.set_title(_("About Menu Editor"))
        self.set_program_name("OpenKylinMenuEditor")
        self.set_logo_icon_name("OpenKylinMenuEditor")
        self.set_copyright("Copyright © 2026 Tiago Camacho - Fork MenuLibre")
        self.set_authors(authors)
        self.set_documenters(documenters)
        self.set_website("https://github.com/camachoti/OpenKylinMenuEditor")
        self.set_version(openkylinmenueditor_lib.get_version())
...
class HelpDialog(Gtk.MessageDialog):
    ...
    def response_cb(self, widget, response):
        if response == Gtk.ResponseType.OK:
            url = "https://github.com/bluesabre/openkylinmenueditor/wiki"
            logger.debug("Navigating to help page, %s" % url)
            openkylinmenueditor_lib.show_uri(self.get_transient_for(), url)
        widget.destroy()
