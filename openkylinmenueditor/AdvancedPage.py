...
class AdvancedPage(Gtk.ScrolledWindow):
    ...
    def __init__(self, use_headerbar):
        ...
        self._add_row(
            ...
            _("More Information"),
            "https://github.com/bluesabre/openkylinmenueditor/wiki/Recognized-Desktop-Entry-Keys#dbusactivatable")
        ...
        self._add_row(
            ...
            _("More Information"),
            "https://github.com/bluesabre/openkylinmenueditor/wiki/Recognized-Desktop-Entry-Keys#prefersnondefaultgpu")
        ...
        self._add_row(
            ...
            _("More Information"),
            "https://github.com/bluesabre/openkylinmenueditor/wiki/Recognized-Desktop-Entry-Keys#x-gnome-usesnotifications")
