...
class ApplicationEditor(Gtk.Box):
    ...
    def __init__(self, use_headerbar):
        ...
        header_card.get_style_context().add_class("openkylinmenueditor-card")
        ...
        label = FieldLabel(
            ...
            "https://github.com/bluesabre/openkylinmenueditor/wiki/Recognized-Desktop-Entry-Keys#exec")
