...
class MenulibreWindow(Gtk.ApplicationWindow):
    ...
    def root_lockout(self):
        if root:
            ...
            docs_url = "https://github.com/bluesabre/openkylinmenueditor/wiki/Frequently-Asked-Questions"
    ...
    def configure_application_window(self, app):
        ...
        self.set_icon_name("openkylinmenueditor")
    ...
    def configure_css(self):
        ...
        .openkylinmenueditor-card > label {{
            margin: 2px 4px;
        }}
...
# Action Functions
    ...
    def save_launcher(self, temp=False):  # noqa
        ...
        if temp:
            filename = tempfile.mkstemp('.desktop', 'openkylinmenueditor-')[1]
        else:
    ...
    def update_launcher_category_dirs(self):  # noqa
        ...
        # Prior to openkylinmenueditor being restarted, addition of a category does not
...
class Application(Gtk.Application):
    ...
    def __init__(self):
        ...
        self.settings_file = os.path.expanduser("~/.config/openkylinmenueditor.cfg")

    def set_use_headerbar(self, preference):
        try:
            settings = GLib.KeyFile.new()
            settings.set_boolean("openkylinmenueditor", "UseHeaderbar", preference)
    ...
    def get_use_headerbar(self):
        ...
        try:
            ...
            return settings.get_boolean("openkylinmenueditor", "UseHeaderbar")
        except:  # noqa
            return None
