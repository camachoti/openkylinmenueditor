#!/usr/bin/python3
# -*- coding: utf-8 -*-
"""Qt dialogs — replaces openkylinmenueditor/Dialogs.py (Gtk.Dialog variants)."""
...
class AboutDialog(QDialog):
    """About dialog for OpenKylinMenuEditor."""
    ...
    def __init__(self, parent=None):
        ...
        # Logo
        logo_label = QLabel()
        icon = get_icon('OpenKylinMenuEditor')
        ...
        # App name + version
        name_label = QLabel(
            '<b><big>OpenKylinMenuEditor</big></b><br/>'
            'v%s' % openkylinmenueditor_lib.get_version()
        )
        ...
        # Website
        link = QLabel(
            '<a href="https://github.com/camachoti/OpenKylinMenuEditor">'
            'github.com/camachoti/OpenKylinMenuEditor</a>'
        )
